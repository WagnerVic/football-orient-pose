"""Cenário B — From Scratch, com Data Augmentation.

Igual ao Cenário A mas com MotionBlur e RandomErasing no pipeline de treino.
Isola o efeito do augmentation partindo dos mesmos pesos aleatórios.
